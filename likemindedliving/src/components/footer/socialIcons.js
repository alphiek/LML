...
export const Fb = () => (
   <Icon viewBox="0 0 13.9 30"
          alt='Facebook Link'>
            <path d="M13.4,15H9.2v15H2.9V15H0V9.7h2.9V6.3c0-0.9,0.2-1.8,0.5-2.7c0.4-1,1-1.9,1.9-2.5
            C6.5,0.3,7.8-0.1,9.2,0l4.6,0v5.1h-3.4c-0.3,0-0.6,0.1-0.9,0.3C9.3,5.8,9.2,6.2,9.2,6.6v3.1h4.7L13.4,15z"/>
   </Icon>
)

export const Insta = () => (
   <Icon viewBox="0 0 29.9 30"
          alt='Instagram Link'>
            <path d="M3.7,7.4V0.9c0-0.2,0-0.3,0.1-0.5c0.1-0.1,0.3-0.2,0.5-0.2l0.3-0.1v7.2h1.2V0h0.8v7.4h1.2V0H24
